/**
 * Configuration settings for Error Detection analysis pipeline
 */
module.exports = {
  // Statement Segmentation Configuration
  MIN_STATEMENT_WORDS: 3,
  MIN_STATEMENT_LENGTH: 10,

  // Candidate Trusted Evidence Selection
  MAX_CANDIDATES: 5,
  KEYWORD_OVERLAP_MIN: 0.15,
  ...
  // Contradiction Heuristic Configuration
  CONTRADICTION_MIN_OVERLAP: 0.35,
  NUMERIC_MATCH_REQUIRED: true,

  // Stop words list for preprocessor
  STOP_WORDS: new Set([
